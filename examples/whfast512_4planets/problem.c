...
double run(int use_whfast512){
    ...
    for (int i = 0; i < 5; i++) {
        struct reb_particle p = {
            .m = all_4_mass2[i],
            .x = all_4_pos2[i][0], .y = all_4_pos2[i][1], .z = all_4_pos2[i][2],
            .vx = all_4_vel2[i][0], .vy = all_4_vel2[i][1], .vz = all_4_vel2[i][2]
        };
        reb_add(r2, p);
    }
    ...
    for (int i = 0; i < 5; i++) {
        struct reb_particle p = {
            .m = all_4_mass1[i],
            .x = all_4_pos1[i][0], .y = all_4_pos1[i][1], .z = all_4_pos1[i][2],
            .vx = all_4_vel1[i][0], .vy = all_4_vel1[i][1], .vz = all_4_vel1[i][2]
        };
        reb_add(r1, p);
    }
    ...
    struct reb_simulation *r = combine_simulations(r1, r2);
    ...
    */
    ...
    double tmax = 1000000*2*M_PI; // 15 days
    int err = 0;
    if (use_whfast512){
